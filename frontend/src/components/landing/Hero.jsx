...
export default function Hero() {
  return (
    <section className="restaurant-main-bg relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 md:pt-20 lg:pt-24 pb-12 sm:pb-16 md:pb-20 lg:pb-24">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="text-center lg:text-left space-y-5 sm:space-y-6">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
              ...
              <span className="text-bronze-400">Qruzine Platform</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-6 pt-6 sm:pt-8 max-w-md mx-auto lg:mx-0">
              {[
                ...
                <div key={index} className="text-center">
                  ...
                  <div className="text-sm sm:text-base font-medium text-white">{item.title}</div>
